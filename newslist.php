								...
								<div id="tg-content" class="tg-content">
									<div class="tg-newslist">
										...
										<div class="row">
												...
												<article class="tg-post">
													...
													<div class="tg-postcontent">
														...
														<ul class="tg-postmetadata">
															<li><a href="#"><i class="fa fa-comment-o"></i><i>21,415 Comments</i></a></li>
															<li><a href="#"><i class="fa fa-eye"></i><i>24,565 Views</i></a></li>
														</ul>
													</div>
												</article>
											</div>
											...
											<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
												<article class="tg-post">
													<figure><a href="#"><img src="images/blog/img-05.jpg" alt="image description"></a></figure>
													<div class="tg-postcontent">
														<ul class="tg-bookscategories">
															<li><a href="#">Adventure</a></li>
															<li><a href="#">Fun</a></li>
											...
											<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
												<article class="tg-post">
													<figure><a href="#"><img src="images/blog/img-06.jpg" alt="image description"></a></figure>
													<div class="tg-postcontent">
														<ul class="tg-bookscategories">
															<li><a href="#">Adventure</a></li>
															<li><a href="#">Fun</a></li>
											...
											<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
												<article class="tg-post">
													<figure><a href="#"><img src="images/blog/img-07.jpg" alt="image description"></a></figure>
													<div class="tg-postcontent">
														<ul class="tg-bookscategories">
															<li><a href="#">Adventure</a></li>
															<li><a href="#">Fun</a></li>
