            ...
            ?>
                <table class="table" border="0" cellpadding="0" cellspacing="0">
                    <div class="header-cart-item" style="margin-bottom:20px;background: #f5f5f5;">
                        <tbody id="cart-items">
                        <h2 style="color:orangered;margin-left: 89%; font-size: 22px; ">Chờ lấy hàng</h2><hr>
                ...
                <div style="padding:20px 0px;border-top: 1px dotted rgba(0,0,0,.09);">
                    ...
                    <div class="clearfix" style="margin-left:80%; ">
                        <div class="fl-right" style="display: flex;">
                            ...
                            <button class="btn" id="checkout-cart" style="background:#fff;color:black;">Hủy Đơn</button>
                        </div>
                    </div>
                </div>
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                ?>
                    <table class="table" border="0" cellpadding="0" cellspacing="0">
                        <div class="header-cart-item" style="margin-bottom:20px;background: #f5f5f5;">
                            <tbody id="cart-items">
                            <h2 style="color:orangered; margin-left: 89%;font-size: 22px; " >Đang vận chuyển</h2><hr>
                                <?php foreach ($order_items as $item) { ?>
                                    <tr>
                                        <td>
                                            <a href="#" title="" class="thumb"><img style="width:90px;" src="images/Image/VanHoc/<?= $item['anh']; ?>" alt=""></a>
                    ...
                    <div style="padding:20px 0px;border-top: 1px dotted rgba(0,0,0,.09);">
                        ...
                        <div class="clearfix" style="margin-left:80%; ">
                            <div class="fl-right" style="display: flex;">
                                <button class="btn" id="checkout-cart" style="background:orangered;color:white;" disabled>Đang giao </button>
                ...
                ?>
                    <table class="table" border="0" cellpadding="0" cellspacing="0">
                        <div class="header-cart-item" style="margin-bottom:20px;background: #f5f5f5;">
                            ...
                            <tbody id="cart-items">
                                <h2 style="color:orangered; margin-left: 89%; font-size: 22px;" >Đã giao</h2><hr>
                                <?php foreach ($order_items as $item) { ?>
                                    <tr>
                                        <td>
                                            <a href="#" title="" class="thumb"><img style="width:90px;" src="images/Image/VanHoc/<?= $item['anh']; ?>" alt=""></a>
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            ?>
                <table class="table" border="0" cellpadding="0" cellspacing="0">
                    <div class="header-cart-item" style="margin-bottom:20px;background: #f5f5f5;">
                        <tbody id="cart-items">
                        <h2 style="color:orangered;margin-left: 89%;  font-size: 22px;" class="mess" >Đã Hủy</h2><hr>
                            <?php foreach ($order_items as $item) { ?>
                                <tr>
                                    <td>
                                        <a href="#" title="" class="thumb"><img style="width:90px;" src="images/Image/VanHoc/<?= $item['anh']; ?>" alt=""></a>
